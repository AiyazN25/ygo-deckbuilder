...
export const filterCards = (inWhichDeckControl, inWhichCardSection, searchFilterValue) => (
    {
...
export const sendCard = (toWhichDeckControl, toWhichCardSection, card, fromWhichDeckControl, fromWhichCardSection) => (
    {
...
export const openClearWarningModal = (inWhichDeckControl, inWhichCardSection) => (
    {
...
export const selectCard = (inWhichDeckControl, card, cardIndex, inWhichCardSection) => (
    {
